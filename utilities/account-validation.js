...
validate.checkUpdateData = async (req, res, next) => {
  ...
  // Check if email already exists (but allow same email for same account)
  ...
  if (existingEmail) {
    ...
    if (accountData.account_email !== account_email) {
      ...
      errorsArray.push({ msg: "Email already exists. Please use a different email." })
      errors = { array: () => errorsArray, isEmpty: () => false }
    }
  }
